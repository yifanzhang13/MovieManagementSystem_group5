      ...
      jspdf: {                          // jsPDF / jsPDF-AutoTable related options
        ...
        autotable: {
          styles: {
            ...
            rowHeight:     12,
            fontSize:      8,
            fillColor:     255,         // Color value or 'inherit' to use css1 background-color from html table
            textColor:     50,          // Color value or 'inherit' to use css1 color from html table
            fontStyle:     'normal',    // normal, bold, italic, bolditalic or 'inherit' to use css1 font-weight and fonst-style from html table
        ...
        loadImages(teOptions, function () {
          $(el).filter(function () {
            ...
            if ( typeof atOptions.createdHeaderCell !== 'function' ) {
              // apply some original css1 styles to pdf header cells
            ...
            if ( typeof atOptions.createdCell !== 'function' ) {
              // apply some original css1 styles to pdf table cells
