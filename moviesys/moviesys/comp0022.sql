...
-- ----------------------------
-- Table structure for library_movies
-- ----------------------------
DROP TABLE IF EXISTS `library_movies`;
...
-- ----------------------------
-- Table structure for library_ratings
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=100837 DEFAULT CHARSET=utf8;
